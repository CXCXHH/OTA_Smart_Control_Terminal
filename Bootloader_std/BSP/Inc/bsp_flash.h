...
#define STM32_B_PAGE_COUNT  20                                                          // B区页数 (20KB)
#define STM32_A_PAGE_COUNT  (FLASH_PAGE_COUNT - STM32_B_PAGE_COUNT)                     // A区页数 (44KB)

// A区起始 = 紧接 B区 之后
#define STM32_A_START_PAGE  STM32_B_PAGE_COUNT                                          // A区起始页号 (=20)
#define STM32_A_START_ADDR  (FLASH_BASE_ADDR + STM32_A_START_PAGE * FLASH_PAGE_SIZE)    // A区起始地址 (0x08005000)
 ...
 * 第 0~19 页 (0x08000000 ~ 0x08004FFF) 共 20KB 预留给 bootloader (B区)，
 * 用户固件从第 20 页开始 (A区)。
 *---------------------------------------------------------------------------*/
