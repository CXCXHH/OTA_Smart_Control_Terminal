...
#include "modbus_app.h"      /* REG_HOLD_BUF — shared with Modbus/CANopen */
...
static UNS32 DeviceInfo_StoreCallback(CO_Data* d, const indextable *OD_entry, UNS8 bSubindex)
{
  (void)d;
  (void)OD_entry;
  ...
  switch (bSubindex) {
    case 1:
      Canopen_RequestApplyControl(DeviceInfo_Control);
      break;

    case 10:
      Canopen_RequestApplySlaveAddr(DeviceInfo_SlaveAddress);
      break;
...
/* index 0x2000 :   Mapped variable DeviceInfo — shares REG_HOLD_BUF with Modbus */
                    UNS8 TestSlave_highestSubIndex_obj2000 = 10; /* number of subindex - 1*/
                    ODCallback_t DeviceInfo_callbacks[] =
                     {
                       NULL,
                       DeviceInfo_StoreCallback,
                       NULL,
                       NULL,
                       NULL,
                       NULL,
                    ...
                    subindex TestSlave_Index2000[] =
                     {
                       ...
                       { RW, uint8, sizeof (UNS8), (void*)&DeviceInfo_Control },
                       { RO, uint16, sizeof (UNS16), (void*)&DeviceInfo_TP },
                       { RO, uint16, sizeof (UNS16), (void*)&DeviceInfo_RH },
                       { RO, uint16, sizeof (UNS16), (void*)&DeviceInfo_VL },
                       { RO, uint16, sizeof (UNS16), (void*)&DeviceInfo_CU },
                       { RO, uint16, sizeof (UNS16), (void*)&DeviceInfo_PW },
                       { RO, uint16, sizeof (UNS16), (void*)&DeviceInfo_VR },
                       { RO, uint16, sizeof (UNS16), (void*)&DeviceInfo_CPU },
                       { RO, uint16, sizeof (UNS16), (void*)&DeviceInfo_RES },
                       { RW, uint8, sizeof (UNS8), (void*)&DeviceInfo_SlaveAddress }
                     };
